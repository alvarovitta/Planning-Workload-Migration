...
| Access Points |   |   |   |
    ...
    Complexity - Number of custom user interface pages determines the complexity of the UI 
    1 = All Custom, Branded Pages (>50) & Navigation (Many wizards, branded buttons and links) <br />
    3 = Some Custom Pages (~30) & Navigation (A few buttons, but mostly standard) <br />
