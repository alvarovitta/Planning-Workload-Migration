...
| Attribute | Description | Values | Contributes to: |
| --- | --- | --- | --- |
| Business Continuit  |   |   | xxx |
| Tools Integration |   |   | xxx |
| Deployment |   |   | xxx |

    Business Continuity - The greater the requirement for availability the greater the benefit in moving to the cloud.
    1 = Availability not critical<br />
    2 = Low Availability required (90%)<br />
    3 = Moderate Availability required (99% - "two nines")<br />
    4 = High Availability required (99.9% - "three nines")<br />
    ...
    1 = Very Low: No monitoring tools in use<br />
    2 = Low: Antiquated, ineffective monitoring tool in use<br />
    3 = Moderate: Isolated monitoring tool<br />
    4 = High: Integrated monitoring and reporting<br />
    ...
    1 = Simple, infrequent deployment<br />
    3 = Regular, managed deployments with occasional issues<br />
