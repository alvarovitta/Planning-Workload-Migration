...
| Attribute | Description | Values | Contributes to: |
| --- | --- | --- | --- |
| Business Continuity | The greater the requirement for availability, the greater the benefit in moving to the cloud. | 1 = Availability not critical<br />2 = Low Availability required (90%)<br />3 = Moderate Availability required (99% - "two nines")<br />4 = High Availability required (99.9% - "three nines")<br />5 = Highest Availability and SLA is critical (99.999% - "five nines") | xxx |
