...
## Procedure - How to asses your applicaitons and assign values to your Workload profile
...
<br />
  ...
  2. User Interface Architecture - Number of custom user interface pages determines the complexity of the UI.
